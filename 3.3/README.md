...
1. Build
  ...
  ```
2. Copy <your_country>.osm.pbf to a local directory (i.e. /home/me/nominatimdata). Download it at http://download.geofabrik.de/south-america/brazil-latest.osm.pbf 
